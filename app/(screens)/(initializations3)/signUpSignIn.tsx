...
import { CountryButton, CountryItem, CountryPicker } from "react-native-country-codes-picker";
...
const signUpSignIn = () => {
    ...
    const { setCountryCode, countryCode, phoneNumber, setPhoneNumber } = useContext(UserFormContext);

    const { sendVerification, } = useContext(FirebaseContext);
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <SafeAreaView style={{ flex: 1, backgroundColor: Colors.background }}>
              ...
              <View style={styles.mainContainer}>
                  <View
                      style={{ position: "absolute", left: "28%", top: "15%" }}
                  >
                      <Image
                          source={logo}
                          style={{
